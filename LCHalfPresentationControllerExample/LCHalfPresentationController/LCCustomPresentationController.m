//
//  LCCustomPresentationController.m
...
@interface LCCustomPresentationController () <UIViewControllerAnimatedTransitioning>
@property (nonatomic, strong) UIView *dimmingView;
@property (nonatomic, strong) UIView *presentationWrappingView;
@end


@implementation LCCustomPresentationController
...
- (void)presentationTransitionWillBegin
{
    ...
    // SEE ALSO: The note in AAPLCustomPresentationSecondViewController.m.
    {
        ...
        presentationWrapperView.layer.shadowOpacity = 0.f;
        presentationWrapperView.layer.shadowRadius = 0.f;
